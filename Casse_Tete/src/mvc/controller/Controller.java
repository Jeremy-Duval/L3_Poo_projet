...
public class Controller extends Observable {
    ...
    /**
     * Supprime le chemin si celui ci est incorect et notify de la fin du drag
     * an drop.
     *
     * @param c int : colonne de la case
     * @param r int : ligne de la case
     ...
     *
     * @param path Chemin : chemin pour lequel réinitialiser le lien des cases à
     * VIDE.
     * @author Jérémy
     */
     ...
     *
     * @param grid Grille : la grille à tester
     * @param largeurGrille int : largeur de la grille
     * @param longueurGrille int : longueur de la grille
     * @return boolean : true si le niveau est gagné, false sinon
     */
    ...
    /**
     * Place les symboles pour le niveau suivant.
     *
     * @param grid Grille : grille où placer les symboles
     * @return int : le numéros du niveau
     */
    ...
    /**
     * Reinitialise tout les liens et supprime les chemins
     */
    ...
    /**
     * Notifie l'Observer d'une mise à jour
     */
